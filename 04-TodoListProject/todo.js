...
class TodoApp {
    ...
    async welcomeScreen() {
        const startingAnimation = chalkAnimation.karaoke(boxen(`
...
`, {
    ...
    async endingScreen() {
        const endingAnimation = chalkAnimation.karaoke(`Thank You For Using Our Todo App!`);
        await this.sleep();
    ...
    async deleteTask() {
        ...
        const deletedTaskIndex = this.todoItemsList.indexOf(userInput.todoItem);
    ...
    async updateTask() {
        ...
        const oldTaskIndex = this.todoItemsList.indexOf(userInput.todoItem);
